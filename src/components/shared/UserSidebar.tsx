            ...
            {!isCollapsed && (
              <Link href="/dashboard" className="flex items-center gap-3 group">
                <div className="relative">
                  ...
                  <div className="relative w-9 h-9 bg-linear-to-br from-primary to-gray-700 rounded-lg flex items-center justify-center shadow-sm">
                    <Sparkles className="text-white" size={18} />
                  </div>
                </div>
                <span className="text-xl font-extrabold bg-linear-to-r from-primary to-gray-700 bg-clip-text text-transparent leading-tight">
                  Dashboard
                </span>
              </Link>
            )}
